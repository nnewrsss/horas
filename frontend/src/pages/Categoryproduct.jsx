...
//     const { childCategoryId } = useParams();  // Get child category ID from URL params
//     const [products, setProducts] = useState([]);
//     const [loading, setLoading] = useState(true);
//     const [error, setError] = useState(null);

//     // Fetch products by child category when the component mounts
//     useEffect(() => {
//         const fetchProductsByChildCategory = async () => {
//             try {
//                 const response = await axios.get(`http://127.0.0.1:8000/products/childcategory/${childCategoryId}/`);
...
//     return (
//         <div>
//             <h1>Products in Child Category {childCategoryId}</h1>
