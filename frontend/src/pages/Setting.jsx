...
//     useEffect(() => {
//         if (selectedProvince && selectedAmphure && selectedTambon && selectedZipcode && houseNumber) {
//             const fullAddress = `บ้านเลขที่ : ${houseNumber}, จังหวัด : ${selectedProvince}, อำเภอ : ${selectedAmphure}, ตำบล : ${selectedTambon}, รหัสไปรษณีย์ : ${selectedZipcode}`;
//             setFormData(prevData => ({
//                 ...prevData,
//                 address: fullAddress
//             }));
//         } else if (selectedProvince && selectedAmphure && selectedTambon && selectedZipcode) {
//             // If house number is not provided
//             const fullAddress = `จังหวัด : ${selectedProvince}, อำเภอ : ${selectedAmphure}, ตำบล : ${selectedTambon}, รหัสไปรษณีย์ : ${selectedZipcode}`;
//             setFormData(prevData => ({
//                 ...prevData,
//                 address: fullAddress
//             }));
//         }
//     }, [selectedProvince, selectedAmphure, selectedTambon, selectedZipcode, houseNumber]);
...
//         // The address concatenation is handled by the useEffect above
//     };
